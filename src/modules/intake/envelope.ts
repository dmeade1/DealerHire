 ...
 * Queue publication is non-gating and happens after.
 */
export async function acceptApplication(sql: Sql, input: AcceptApplicationInput) {
  ...
  try {
    ...
    if (message.includes("idempotency_key") || message.includes("unique")) {
